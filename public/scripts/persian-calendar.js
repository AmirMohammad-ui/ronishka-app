if ("undefined" === typeof calendar) var calendar = {};
var lastOpenPDatePicker = !1,
  lastOpenPDateMonthYearID = !1,
  pDatePickerZIndex = 1E3,
...
calendar.persian.prototype.showHidePicker = function (b) {
  ...
  if (c = A$(a)) {
    ...
    this.setMenuPos(c,
      d);
    c.style.zIndex = !lastOpenPDatePicker ? pDatePickerZIndex = 1E3 : ++pDatePickerZIndex;
...
calendar.persian.prototype.createDateTable = function (b, a, c) {
  var d = cE("table"),
    e, g, f, h, k, j;
...
calendar.persian.prototype.changePickerDate = function (b, a, c) {
  var d;
...
calendar.persian.prototype.showMonthPicker = function (b, a, c) {
  var d, e, g;
...
calendar.persian.prototype.showYearPicker = function (b, a, c) {
  var d, e, g;
  if (A$(this.inputID + "_pDatePicker")) {
    b || (b = window.event);
    (e = A$(lastOpenPDateMonthYearID)) && e.parentNode.removeChild(e);
    ...
    e.className = "monthYearPicker";
    e.id = lastOpenPDateMonthYearID = this.inputID + "monthYearPicker";
    for (d = c - 30; d <= c + 30; ++d) g = cE("a"), g.href = "#", g.appendChild(cTN(enDigitsToFa(d))), d == c && (g.className = "selected"), g.onclick = function (a, b, c) {
      return function (d) {
        a.monthYearPickerClick(d, b, c);
        return !1
      }
...
calendar.persian.prototype.setMenuPos = function (b, a) {
  var c = getOffset(a);
...
calendar.persian.prototype.monthYearPickerClick = function (b, a, c) {
  var d, e;
...
calendar.persian.prototype.normalizeUserInput = function () {
  var b = this.input,
    a, c = b.value.trim(),
    c = faDigitsToEn(c);
  (a = isPersianDate(c)) ? this.fillDateField(a): (a = removeCssClass(b.className, "valid"), a = removeCssClass(a, "invalid"), "" !== c && (a += " invalid"), b.className = a, this.getOption("extraInputID").length && (A$(this.getOption("extraInputID")).value = ""))
};
calendar.persian.prototype.fillDateField = function (b) {
  var a = this.input,
    c;
...
calendar.persian.prototype.keyDownHandler = function (b, a) {
  var c;
  b || (b = window.event);
